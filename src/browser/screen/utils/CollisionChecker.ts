class CollisionChecker {
    ...
    private checkBetween(point: number, start: number, end: number): boolean {
    ...
    public checkPointInRect(
        ...
        rectScaleX: number, rectScaleY: number,
        rectSin: number, rectCos: number
    ): boolean {
    ...
    public checkPointInCircle(
        ...
        circleScaleX: number, circleScaleY: number,
        circleSin: number, circleCos: number
    ): boolean {
    ...
    public checkPointInPolygon(
        ...
        polygonScaleX: number, polygonScaleY: number,
        polygonSin: number, polygonCos: number
    ): boolean {
    ...
    public checkLineLine(
        ax: number, ay: number,
        aStartX: number, aStartY: number,
        aEndX: number, aEndY: number,
        aScaleX: number, aScaleY: number,
        aSin: number, aCos: number,

        bx: number, by: number,
        bStartX: number, bStartY: number,
        bEndX: number, bEndY: number,
        bScaleX: number, bScaleY: number,
        bSin: number, bCos: number
    ): boolean {
    ...
    public checkLineRect(
        ...
        const cw = rectCos * rectWidth; const ch = rectCos * rectHeight;
        const sw = -rectSin * rectWidth; const sh = -rectSin * rectHeight;

        const rectPoint1X = rectX - cw - sh; const rectPoint1Y = rectY + sw - ch;
        const rectPoint2X = rectX + cw - sh; const rectPoint2Y = rectY - sw - ch;
        const rectPoint3X = rectX + cw + sh; const rectPoint3Y = rectY - sw + ch;
        const rectPoint4X = rectX - cw + sh; const rectPoint4Y = rectY + sw + ch;
    ...
    public checkLinePolygon(
        ...
        for (let i = 0, j = length - 1; i < length; j = i, i += 1) {
            ...
            if (this.checkLineLine(
                0, 0, lineTempStartX, lineTempStartY, lineTempEndX, lineTempEndY, 1, 1, 0, 1,
                0, 0, polygonPoint1X, polygonPoint1Y, polygonPoint2X, polygonPoint2Y, 1, 1, 0, 1,
            ) === true) {
                return true;
            }
        }
    ...
    public checkRectRect(
        ax: number, ay: number,
        aWidth: number, aHeight: number,
        aScaleX: number, aScaleY: number,
        aSin: number, aCos: number,

        bx: number, by: number,
        bWidth: number, bHeight: number,
        bScaleX: number, bScaleY: number,
        bSin: number, bCos: number
    ): boolean {
        ...
        const aCW = aCos * aWidth / 2; const aCH = aCos * aHeight / 2;
        const aSW = -aSin * aWidth / 2; const aSH = -aSin * aHeight / 2;

        const aPoint1X = ax - aCW - aSH; const aPoint1Y = ay + aSW - aCH;
        const aPoint2X = ax + aCW - aSH; const aPoint2Y = ay - aSW - aCH;
        const aPoint3X = ax + aCW + aSH; const aPoint3Y = ay - aSW + aCH;
        const aPoint4X = ax - aCW + aSH; const aPoint4Y = ay + aSW + aCH;
        ...
        const bCW = bCos * bWidth / 2; const bCH = bCos * bHeight / 2;
        const bSW = -bSin * bWidth / 2; const bSH = -bSin * bHeight / 2;

        const bPoint1X = bx - bCW - bSH; const bPoint1Y = by + bSW - bCH;
        const bPoint2X = bx + bCW - bSH; const bPoint2Y = by - bSW - bCH;
        const bPoint3X = bx + bCW + bSH; const bPoint3Y = by - bSW + bCH;
        const bPoint4X = bx - bCW + bSH; const bPoint4Y = by + bSW + bCH;
    ...
    public checkRectPolygon(
        ...
        const cw = rectCos * rectWidth / 2; const ch = rectCos * rectHeight / 2;
        const sw = -rectSin * rectWidth / 2; const sh = -rectSin * rectHeight / 2;
        ...
        for (let i = 0, j = length - 1; i < length; j = i, i += 1) {
            ...
            if (
                this.checkLineLine(0, 0, rectPoint1X, rectPoint1Y, rectPoint2X, rectPoint2Y, 1, 1, 0, 1, 0, 0, polygonPoint1X, polygonPoint1Y, polygonPoint2X, polygonPoint2Y, 1, 1, 0, 1) === true ||
    ...
    private realRoot(z4: number, z3: number, z2: number, z1: number, z0: number): boolean {
    ...
    public checkCirclePolygon(
        ...
        for (let i = 0, j = length - 1; i < length; j = i, i += 1) {
            ...
            if (this.checkLineCircle(
                0, 0, polygonPoint1X, polygonPoint1Y, polygonPoint2X, polygonPoint2Y, 1, 1, 0, 1,
                circleX, circleY, circleWidth, circleHeight, 1, 1, circleSin, circleCos,
            ) === true) {
                return true;
            }
        }
    ...
    public checkPolygonPolygon(
        ...
        for (let i = 0; i < bLength; i += 1) {
            ...
            if (this.checkPointInPolygon(
                bPoint1X, bPoint1Y,
                ax, ay, aPoints,
                aScaleX, aScaleY, aSin, aCos) === true) {
                return true;
            }
        }
        ...
        for (let i = 0, j = aLength - 1; i < aLength; j = i, i += 1) {
            ...
            if (this.checkPointInPolygon(
                aPoint1X, aPoint1Y,
                bx, by, bPoints,
                bScaleX, bScaleY, bSin, bCos) === true) {
                return true;
            }
            ...
            for (let k = 0, l = bLength - 1; k < bLength; l = k, k += 1) {
                ...
                if (this.checkLineLine(
                    0, 0, aPoint1X, aPoint1Y, aPoint2X, aPoint2Y, 1, 1, 0, 1,
                    0, 0, bPoint1X, bPoint1Y, bPoint2X, bPoint2Y, 1, 1, 0, 1,
                ) === true) {
                    return true;
                }
            }
